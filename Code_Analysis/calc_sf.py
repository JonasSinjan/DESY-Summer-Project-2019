...
if __name__ == '__main__':
    ...
    #desy cluster path
    dir_data = '/lustre/fs23/group/that/jonas/Github_repo/DESY/phi0init/Runs/512_5_3/'  # data files
    dir_output = '/lustre/fs23/group/that/jonas/Github_repo/DESY/phi0init/Runs/512_5_3/'  # data files
    ...
    if twoD_bool is True:
        ...
        f = open(dir_output + 'sf_par_perp_v_phi0_wrt_global_10_kpara' + mode + '.txt', 'w')
        for i in range(0, int(lent / 2)):
