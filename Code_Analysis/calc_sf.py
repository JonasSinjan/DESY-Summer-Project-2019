...
if __name__ == '__main__':
    ...
    dir_output = '/lustre/fs23/group/that/jonas/Github_repo/DESY/localB/Runs/512_B_amp04/'  # data files
    ...
    if twoD_bool:
        ...
        #3D PHI0
        localbool = True
        phi0,bx,by,bz,mach_alfven= read_files3D_phi0(dir_phi0, dir_B, local=True)
        ...
        f = open(dir_output + 'sf_par_perp_v_phi0_wrt_local_amp04' + mode + '.txt', 'w')
        for i in range(0, int(lent / 2)):
