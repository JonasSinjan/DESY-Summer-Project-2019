...
if __name__ == '__main__':
    ...
    dir_data = '/lustre/fs23/group/that/jonas/Github_repo/DESY/final_data/2d/512run2D_disp_real/'  # data files
    dir_output = '/lustre/fs23/group/that/jonas/Github_repo/DESY/final_data/2d/512run2D_disp_real/'  # data files
