...
ax0.plot(lperp5[:count], lpar5[:count], ls = "--", lw=3,label="128_73")
ax0.plot(lperp6[:count_256], lpar6[:count_256], ls = "--", lw=3, label="256_73")
...
ax0.plot(lperp7[:count_512], ref_slope_2_3, lw=4,label="GS95",color="orange")
ax0.set_xscale('log')
ax0.set_yscale('log')
